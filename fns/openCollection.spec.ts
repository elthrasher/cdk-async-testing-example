...
import { handler } from './openCollection';

import type { Context } from 'aws-lambda';

const event = {
  account: '',
  detail: { id: '1', status: PaymentStatus.FAILURE },
...
describe('open a payment for collections', () => {
  test('update the DynamoDB table with a collections response', async () => {
